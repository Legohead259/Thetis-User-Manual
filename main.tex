...
\begin{document}
    ...
    \input{sections/technical_specifications}
    \input{sections/calibration}
    \input{sections/human_interfaces}
    \input{sections/data_logger}
    \input{sections/communication_protocol}
    \input{sections/sample_rates}
    \input{sections/network_announcement}
    \input{sections/device_settings}

    \clearpage
    \input{glossary}

    \clearpage
    \input{document_version_history.tex}
